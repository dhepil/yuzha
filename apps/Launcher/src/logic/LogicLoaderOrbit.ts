...
export function buildOrbit(app: Application, built: BuiltLayer[], spinRpmBySprite: Map<Sprite, number>) {
  ...
  for (const b of built) {
    ...
    const orientDeg = typeof b.cfg.orbitOrientDeg === 'number' && isFinite(b.cfg.orbitOrientDeg!) ? b.cfg.orbitOrientDeg! : 0
